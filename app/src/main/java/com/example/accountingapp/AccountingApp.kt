...
class AccountingApp : Application() {
    ...
    companion object {
        val PREDEFINED_CATEGORIES = listOf(
            ...
            Category(name = "居家生活", type = "支出"),
            Category(name = "文化教育", type = "支出"),
            Category(name = "送礼人情", type = "支出"),
            Category(name = "食品餐饮", type = "支出"),
            Category(name = "健康医疗", type = "支出"),
            Category(name = "其他", type = "支出"),
            Category(name = "中奖", type = "收入"),
            Category(name = "理财盈利", type = "收入"),
            Category(name = "礼金人情", type = "收入"),
            Category(name = "借入", type = "收入"),
            Category(name = "奖金", type = "收入"),
            Category(name = "兼职外快", type = "收入"),
            Category(name = "工资", type = "收入"),
            Category(name = "二手闲置", type = "收入"),
            Category(name = "补贴", type = "收入"),
            Category(name = "报销", type = "收入"),
            Category(name = "其他", type = "收入"),
